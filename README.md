...
### Usage
You can run the docker image if the kafka broker you want make use of is running on PLAINTEXT, or SASL_PLAINTEXT using the use cases - I and use case - IV 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MTAwNzI0NjYsLTEyOTkzMTI2MzIsMT
