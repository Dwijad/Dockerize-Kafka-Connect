...
If your kafka broker is running on SASL_SSL or SSL mode then you have to rebuild the docker image incorporating the 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTMyNTgyMjM4MiwtMTI5OTMxMjYzMiwxNT
