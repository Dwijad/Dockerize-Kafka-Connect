...
### Usage
#### Use case - 1
Run Kafka connect worker with Kafka broker listener configured in PLAINTEXT mode. The schema registry is running 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMjgyMzk0Nyw5OTExMTMxNjQsMjAxND
